...
//        System.out.println(problems2.getSmallestMultiple(6));
    ...
    @Test
    public void testRescale_2Test() {
        final int[][] original = new int[4][4];
        int counter = 0;
        ...
        final int newHeight = 4;

        final int[][] newImage = problems2.rescale(original, newWidth, newHeight);
//        System.out.println(newImage[0][0]);
//        System.out.println(newImage[0][1]);
//        System.out.println(newImage[1][0]);
//        System.out.println(newImage[1][1]);
//        
//        System.out.println(Arrays.toString(newImage[0]));
//        System.out.println(Arrays.toString(newImage[1]));
//        System.out.println(Arrays.toString(newImage[2]));
//        System.out.println(Arrays.toString(newImage[3]));
//        System.out.println(Arrays.toString(newImage[4]));
//        System.out.println(Arrays.toString(newImage[5]));
